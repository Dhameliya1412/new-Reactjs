...
<div className="flex" style={{ display:"flex", borderRadius:"10px", marginTop:"490px", marginLeft:"230px" }}>

<div id="indicators-carousel" class="relative w-full h-full" data-carousel="static" style={{width:"700px", minWidth:"992", width: "75%"}}>

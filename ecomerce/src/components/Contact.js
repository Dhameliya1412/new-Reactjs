        ...
        <div className='touch-main row h-60 w-80 border-2 border-gray-400'>
            <div className='mr-0'>
                ...
                <div className=''>
                  ...
                  <a href="#" className='Support-btn bg-red-100 text-black hover:bg-red-700 '>
                  Get Support On Call 
...
{/* 
                ...
                <div>
                  <form class="max-w-sm ">
                    ...
                    <textarea id="message" rows="4" class="block p-2.5 w-[480px] text-sm text-gray-900 bg-gray-50 rounded-lg border  border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-00 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter message"></textarea>
                  </form>
                </div>

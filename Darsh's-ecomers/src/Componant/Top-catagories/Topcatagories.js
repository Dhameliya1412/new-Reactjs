...
<div class="w-52 h-64 mt-5 bg-white shadow dark:bg-gray-100 ">
    ...
    <div class="flex flex-col items-center pb-10"> 
        <img src={cat01} className="bg-slate-300 h-28 w-28 p-7" style={{borderRadius:"100px", fontSize:"50px", textAlign:"center", }}></img>
...
<div class="w-52 h-64 mt-5 bg-white shadow dark:bg-gray-100 ">
    ...
    <div class="flex flex-col items-center pb-10">
        <img src={cat02} className= "bg-slate-300 h-28 w-28 p-7" style={{borderRadius:"100px", fontSize:"50px", textAlign:"center", }}></img>
...
<div class="w-52 h-64 mt-5 bg-white shadow dark:bg-gray-100 ">
    ...
    <div class="flex flex-col items-center pb-10">
        <img src={cat03} className= "bg-slate-300 h-28 w-28 p-7 " style={{borderRadius:"100px", fontSize:"50px", textAlign:"center", }}></img>
        <span class="text-lg  dark:text-gray-900 mt-5">Drift Wood</span>
...
<div class="w-52 h-64 mt-5 bg-white shadow dark:bg-gray-100 ">
    ...
    <div class="flex flex-col items-center pb-10">
        <img src={cat04} className="bg-slate-300 h-28 w-28 p-7" style={{borderRadius:"100px", fontSize:"50px", textAlign:"center", }}></img>
...
<div class="w-52 h-64 mt-5 bg-white shadow dark:bg-gray-100 ">
    ...
    <div class="flex flex-col items-center pb-10">
        <img src={cat05} className= "bg-slate-300 h-28 w-28 p-7" style={{borderRadius:"100px", fontSize:"50px", textAlign:"center", }}></img>
...
<div class="w-56 h-64 mt-5 bg-white shadow dark:bg-gray-100 ">
    ...
    <div class="flex flex-col items-center pb-10">
        <img src={cat06} className=" bg-slate-300 h-28 w-28 p-7 " style={{borderRadius:"100px", fontSize:"50px", textAlign:"center", }}></img>

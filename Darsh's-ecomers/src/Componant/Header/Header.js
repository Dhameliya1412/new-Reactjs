  ...
  return (
    <div>
      <header>
       ...
       <div className='flex justify-around h-14 flex-wrap mt-10'>
          <div className='mt-3 '>
          <img src={logo} alt="" />
          </div>
          ...
          <div className=' bg-slate-200 rounded-lg object-cover '>
            <i class="fa-solid fa-magnifying-glass ms-3 me-3 aline-center"></i>
          ...
          <div className='flex '>
            <div className='flex border ' id='eng'>
              <img src={Uk} alt="" />
            ...
            <div className='ms-2 flex ml-14 border w-32 rounded-md'>

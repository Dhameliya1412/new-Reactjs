...
function Navbar() {
  ...
  return (
    <div>
        <div className="flex flex-col w-44 h-full ml-10 text-white my-5 absolute" >
    
    
    <button id className="flex items-center justify-center h-16 border-b border-gray-950" onClick={toggleDataVisibility} >
        <h1 className="text-xl font-bold bg-red-700 " style={{height:"70px", width:"100%", textAlign:"center", padding:"18px", borderRadius:"10px 10px 0px 0px"}}> <i class="fa-solid fa-bars mr-2"></i> Categories</h1>
    </button>
      ...
      <div className="grid grid-cols-7 items-center mt-4 ">
          ...
          <div className="col-span-6 px-4">
            <div className="flex justify-between">
                ...
                <div className="sm:ml-3">
                  <div className="flex space-x-4 cursor-pointer">
                    <div id="home" className="nav-link relative">
                      <Link to="/"
                        className="rounded-md px-3 my-3 mt-9 inline-block text-lg font-medium home header-link"
                      >
                        Home
                    ...
                    <div id="shop" className="nav-link relative">
                      <a
                        href="#"
                        className="rounded-md px-3 my-3 mt-9 inline-block text-lg font-medium shop header-link"
                      >
                        Shop
                        <i className="fa-solid fa-angle-down ms-1 text-slate-500"></i>
                      </a>
                    ...
                    <div id="page" className="nav-link relative">
                      <a
                        href="#"
                        className="rounded-md px-3 my-3 mt-9 inline-block text-lg font-medium pages header-link"
                      >
                        Pages
                        <i className="fa-solid fa-angle-down ms-1 text-slate-500"></i>
                      </a>
                    ...
                    <div id="blog" className="nav-link relative">
                      <a
                        href="#"
                        className="rounded-md px-3 my-3 mt-9 inline-block text-lg font-medium blog header-link"
                      >
                        Blog
                        <i className="fa-solid fa-angle-down ms-1 text-slate-500"></i>
                      </a>
                    ...
                    <div id="contact" className="nav-link relative">
                      <Link to="/contact"
                        className="rounded-md px-3 my-3 mt-9 inline-block text-lg font-medium contact header-link"
                      >
                        Contact
                      </Link>
                      <ul className="text-start ps-2 rounded-b-lg bg-white text-sm link-lst absolute w-[250%] z-10  border-red-700 border-t-2 py-3">
              ...
              <div className="pe-4 mt-9 text-lg font-semibold flex justify-end items-center">
